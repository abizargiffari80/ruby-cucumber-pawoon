Given(/^user berada di homepage dan sudah memilih produk dan voucher #vouchervoid$/) do 
...
When(/^user batalkan voucher #vouchervoid$/) do
...
Then(/^bisa batalkan voucher #vouchervoid$/) do
    p 'Scenario Sukses'
    sleep(2)
