Given(/^user berada di homepage #vouchercicilan$/) do 
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true
end

And(/^user pilih pelanggan #vouchercicilan$/) do 
    @app.pelanggan.btn_pelanggan.click
    @app.pelanggan.btn_pelangganAutomation.click
    @app.pelanggan.btn_pilihpelanggan.click
end

And(/^user pilih produk normal #vouchercicilan$/) do 
...
And(/^user apply voucher #vouchercicilan$/) do 
...
When(/^user pilih cicilan #vouchercicilan$/) do
    @app.pembayaran.btn_cicilan.click
end

Then(/^tidak bisa apply voucher jika transaksi cicilan #vouchercicilan$/) do
