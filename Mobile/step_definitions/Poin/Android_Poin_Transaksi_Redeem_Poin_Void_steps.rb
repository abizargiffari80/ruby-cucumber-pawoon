Given(/^user berada di homepage #trxredeempoinvoid$/) do
    ...
    #edit harga
    @app.poin.txt_produkDetail.click
    @app.poin.txt_produkDetail_UbahHarga.click
    @app.poin.txt_produkDetail_UbahHarga_Hapus.click
    @app.poin.txt_produkDetail_UbahHarga_Simpan.click
    @app.poin.txt_produkDetail_Simpan.click
    ...
    @app.poin.txtfield_reddempoin.send_keys '100'
...
And(/^batalkan transaksi yang ada redeem poin #trxredeempoinvoid$/) do
    sleep(2)
    @app.transaksi.btn_drawer.click
...
When(/^user pilih pelanggan yang transaksinya dibatalkan #trxredeempoinvoid$/) do
    @app.transaksi.text_produkN1.click
    @app.pelanggan.btn_pelanggan.click
    @app.pelanggan.btn_pelangganAutomation.click
...
Then(/^poin pelanggan kembali bertambah #trxredeempoinvoid$/) do
